...
B0 from the folder's `params.json`. If magnitude is available and no --mask is
given, a brain mask is generated automatically via bet2 (see `bet2_utils.py`) --
pass --mask/--bet_mask to use your own, or --no_bet2 to reconstruct whole-head
instead.
